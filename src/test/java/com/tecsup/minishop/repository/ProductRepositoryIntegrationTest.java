...
class ProductRepositoryIntegrationTest {
    ...
    @Test
    @DisplayName("Debe guardar un producto y asignarle ID automaticamente")
    ...
    @Test
    @DisplayName("Debe buscar productos por nombre ignorando mayusculas")
    void shouldFindProductsByNameIgnoringCase() {
        productRepository.save(Product.builder().name("Teclado Mecanico").price(150.00).stock(20).build());
        ...
        assertThat(result).extracting(Product::getName)
                .containsExactlyInAnyOrder("Teclado Mecanico", "Teclado Membrana");
    }
}
